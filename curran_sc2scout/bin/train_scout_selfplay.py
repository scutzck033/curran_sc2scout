...
flags.DEFINE_integer("max_step", 100000, "Game steps per episode.")
flags.DEFINE_integer("step_mul", 32, "Game steps per agent step.")
flags.DEFINE_integer("random_seed", None, "Random_seed used in game_core.")

flags.DEFINE_string("train_log_dir", './log/dqn_evade', "train log directory")
flags.DEFINE_string("checkpoint_path", './model_save/dqn_evade', "load saved model")
