...
MAP_SIZE = {
    ...
    'Acolyte': (168, 200),
    'ScoutSimple64Evade2': (88, 96),
    'ScoutSimple64Dodge2': (88, 96),
    'ScoutSimple64Dodge3': (88, 96),
    'ScoutSimple64WithQueen': (88,96)
}
...
class ZergScoutSelfplayEnv(SC2SelfplayGymEnv):
    ...
    def _check_enemy(self, u):
        if (u.int_attr.alliance == sm.AllianceType.ENEMY.value) and (u.unit_type in sm.COMBAT_UNITS or u.unit_type in sm.COMBAT_AIR_UNITS):
            return True
        else:
            return False
